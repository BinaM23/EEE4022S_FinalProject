...
%network attributes were kept constant only user specified weights were
...
%assumed constant network attributes/didn't randomise network conditions for now
...
%in my case combination 1 gave the highest average gain
%commented out (Not needed for this experiment)
