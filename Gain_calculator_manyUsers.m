...
%comment it out to use 2018 method value 
%run FAHP_EAM.m with Pu=[3,3,3]
...
%i=1...7
gains1=zeros(1,numUsers); %vectors to store gains for each user for a particular parameter combination
