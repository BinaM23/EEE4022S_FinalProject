...
%Experiment 2 part 2:Varying priority with biased weights
...
%EXPERIMENT 2 PART 2
%the weights of each criterion are biased to reflect importance to the user
%criterion deemed important has weight [7,9] while the rest are given [1,3]
%For the first part this is done for each criterion in all services
%For the second part this is done for all criteria for one service
%Uncomment a particular case to simulate it
...
%Part 1
%case 1: Bandwidth more important to users
wu1=[randi([weights(7),weights(9)]),randi([weights(1),weights(3)]),randi([weights(1),weights(3)]),randi([weights(1),weights(3)])]; %user defined weights for service 1(voice)
wu2=[randi([weights(7),weights(9)]),randi([weights(1),weights(3)]),randi([weights(1),weights(3)]),randi([weights(1),weights(3)])]; %user defined weights for service 2(video)
wu3=[randi([weights(7),weights(9)]),randi([weights(1),weights(3)]),randi([weights(1),weights(3)]),randi([weights(1),weights(3)])]; %user defined weights for service 3(web browsing)

%case 2: Cost more important to users
%wu1=[randi([weights(1),weights(3)]),randi([weights(7),weights(9)]),randi([weights(1),weights(3)]),randi([weights(1),weights(3)])]; %user defined weights for service 1(voice)
%wu2=[randi([weights(1),weights(3)]),randi([weights(7),weights(9)]),randi([weights(1),weights(3)]),randi([weights(1),weights(3)])]; %user defined weights for service 2(video)
%wu3=[randi([weights(1),weights(3)]),randi([weights(7),weights(9)]),randi([weights(1),weights(3)]),randi([weights(1),weights(3)])]; %user defined weights for service 3(web browsing)

%case 3: Delay more important to users
%wu1=[randi([weights(1),weights(3)]),randi([weights(1),weights(3)]),randi([weights(7),weights(9)]),randi([weights(1),weights(3)])]; %user defined weights for service 1(voice)
%wu2=[randi([weights(1),weights(3)]),randi([weights(1),weights(3)]),randi([weights(7),weights(9)]),randi([weights(1),weights(3)])]; %user defined weights for service 2(video)
%wu3=[randi([weights(1),weights(3)]),randi([weights(1),weights(3)]),randi([weights(7),weights(9)]),randi([weights(1),weights(3)])]; %user defined weights for service 3(web browsing)

%Case 4:Loss rate more important to users
%wu1=[randi([weights(1),weights(3)]),randi([weights(1),weights(3)]),randi([weights(1),weights(3)]),randi([weights(7),weights(9)])]; %user defined weights for service 1(voice)
%wu2=[randi([weights(1),weights(3)]),randi([weights(1),weights(3)]),randi([weights(1),weights(3)]),randi([weights(7),weights(9)])]; %user defined weights for service 2(video)
%wu3=[randi([weights(1),weights(3)]),randi([weights(1),weights(3)]),randi([weights(1),weights(3)]),randi([weights(7),weights(9)])]; %user defined weights for service 3(web browsing)

%Part 2
%Case 5: Voice more important to user
%wu1=[randi([weights(7),weights(9)]),randi([weights(7),weights(9)]),randi([weights(7),weights(9)]),randi([weights(7),weights(9)])]; %user defined weights for service 1(voice)
%wu2=[randi([weights(1),weights(3)]),randi([weights(1),weights(3)]),randi([weights(1),weights(3)]),randi([weights(1),weights(3)])]; %user defined weights for service 2(video)
%wu3=[randi([weights(1),weights(3)]),randi([weights(1),weights(3)]),randi([weights(1),weights(3)]),randi([weights(1),weights(3)])]; %user defined weights for service 3(web browsing)

%Case 6: Video more important to user
%wu1=[randi([weights(1),weights(3)]),randi([weights(1),weights(3)]),randi([weights(1),weights(3)]),randi([weights(1),weights(3)])]; %user defined weights for service 1(voice)
%wu2=[randi([weights(7),weights(9)]),randi([weights(7),weights(9)]),randi([weights(7),weights(9)]),randi([weights(7),weights(9)])]; %user defined weights for service 2(video)
%wu3=[randi([weights(1),weights(3)]),randi([weights(1),weights(3)]),randi([weights(1),weights(3)]),randi([weights(1),weights(3)])]; %user defined weights for service 3(web browsing)

%Case 7: Web browsing more important to user
%wu1=[randi([weights(1),weights(3)]),randi([weights(1),weights(3)]),randi([weights(1),weights(3)]),randi([weights(1),weights(3)])]; %user defined weights for service 1(voice)
%wu2=[randi([weights(1),weights(3)]),randi([weights(1),weights(3)]),randi([weights(1),weights(3)]),randi([weights(1),weights(3)])]; %user defined weights for service 2(video)
%wu3=[randi([weights(7),weights(9)]),randi([weights(7),weights(9)]),randi([weights(7),weights(9)]),randi([weights(7),weights(9)])]; %user defined weights for service 3(web browsing)
