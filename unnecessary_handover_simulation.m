...
%threshold and number of users kept constant
...
%t2 = keeps track of the previous iteration to determine if successive
%selection events
...
title('Execution number against percentage of unnecessary handovers');
grid on;
%%
